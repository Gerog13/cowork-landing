      ...
      <section id="servicios" className="bg-white pb-10">
        <div className="container px-6 py-10 mx-auto tracking-tight">
          ...
          <p className="mt-4 text-gray-800 text-lg opacity-80 xl:mt-6">
            Además de todos los beneficios que Workbox ofrece debido a su localización tales como: amplio estacionamiento, patio de comidas, supermercado, farmacia, cajeros, gimnasio,
            seguridad todo el día, fácil acceso y todo tipo de negocios alrededor, contamos con los siguientes servicios.
          </p>
          ...
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
            ...
            <div className="space-y-3 shadow-md p-6 rounded-lg">
              ...
              <p className="text-gray-800">
                Organizá reuniones con tu equipo de forma privada y hacé crecer tu
      ...
      <section className="bg-gray-100 tracking-tight">
        <div className="container flex flex-col items-center px-4 py-12 mx-auto text-center">
          ...
          <p className="block max-w-2xl mt-4 text-xl text-gray-800 opacity-90">
            Workbox te ofrece la posibilidad de realizar diversos eventos,
