...
const Footer = () => {
  return (
    ...
    //   </div>
    // </footer>
    <footer class="flex w-full h-32 items-center justify-between p-4 bg-neonBlue">
      <div>
        <p class="font-sans tracking-wide font-semibold text-base text-platinum">
      ...
      <img
        ...
        width={300}
      />
      <div class="flex w-52 items-center justify-around">
        <a
