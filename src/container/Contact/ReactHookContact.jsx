  ...
  return (
    <div id="contacto" className="flex flex-col items-center pt-10 bg-gray-100">
      ...
      <div
        ...
        className="container px-6 pb-20 mx-auto grid grid-cols-1 lg:grid-cols-2 place-content-center place-items-start"
      >
        <form
          ref={form}
          onSubmit={handleSubmit(sendEmail)}
          className="px-6 py-4 bg-white rounded-md shadow-md dark:bg-gray-800"
        >
          ...
          <div className="grid grid-cols-1 gap-6 mt-6 sm:grid-cols-2 md:grid-cols-3">
            <div className="flex flex-col items-center text-center px-4 py-3 text-gray-900 transition-colors duration-200 transform rounded-md bg-bgGold">
              <svg
                className="w-5 h-5 fill-oldGold"
              ...
              <span className="mt-2">La Barraca Mall, Local L16</span>
            </div>
            ...
            <div className="flex flex-col items-center text-center px-4 py-3 text-gray-900 transition-colors duration-200 transform rounded-md bg-bgGold">
              ...
              <span className="mt-2">+54 9 261 777 7257</span>
            </div>
            ...
            <div className="flex flex-col items-center text-center px-4 py-3 text-gray-900 transition-colors duration-200 transform rounded-md bg-bgGold">
              ...
              <span className="mt-2 break-all">workboxmendoza@gmail.com</span>
            </div>
          </div>
          ...
          <div className="mt-6 ">
            ...
            <div className="w-full mt-4">
              ...
              <textarea
                {...register("message")}
                className="resize-none block w-full h-20 lg:h-40 px-4 py-2 text-gray-700 bg-white border rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40"
              ></textarea>
            </div>
    ...
    //         />
    //         {isEmailSent ? (
    //           <div className="alert alert-success shadow-lg mt-4 rounded-none">
    //             <div>
    //               <svg
    //                 xmlns="http://www.w3.org/2000/svg"
